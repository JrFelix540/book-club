...
__decorate([
    ...
    typeorm_1.ManyToOne(() => _1.User, (user) => user.posts),
...
__decorate([
    ...
    typeorm_1.ManyToOne(() => _1.Community, (community) => community.posts, {
        onDelete: "SET NULL",
    }),
    __metadata("design:type", _1.Community)
...
__decorate([
    ...
    typeorm_1.OneToMany(() => _1.UserComment, (userComment) => userComment.post, {
        onDelete: "CASCADE",
    }),
    __metadata("design:type", Array)
], Post.prototype, "comments", void 0);
__decorate([
    type_graphql_1.Field(() => [_1.Upvote], { nullable: true }),
    typeorm_1.OneToMany(() => _1.Upvote, (upvote) => upvote.post, {
        onDelete: "CASCADE",
    }),
    __metadata("design:type", Array)
